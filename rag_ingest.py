...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
CHROMA_PATH = os.path.join(BASE_DIR, "chroma_db")
FAISS_PATH = os.path.join(BASE_DIR, "faiss_store.pkl")
QDRANT_PATH = os.path.join(BASE_DIR, "qdrant_db")
QDRANT_COLLECTION = "rag_chunks"
MILVUS_COLLECTION = "rag_chunks"
PINECONE_API_KEY = "pcsk_36kLSk_KyRnADaFcY1xF4dS7gyTKjCqBu5qHj8rYMmmr7RP6anZb56YmGZw1Z5BaM1Gznv"
...
if __name__ == "__main__":
    ...
    pdf_path = "demo pdf (2).pdf"
    strategy = "content_aware"  # fixed | sentence | paragraph | recursive | semantic | agentic | content_aware
    vector_db = "pinecone"   # chroma | faiss | qdrant | milvus | pinecone
